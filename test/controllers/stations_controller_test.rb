...
class StationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post stations_url, params: { station: { distance: @station.distance, property_id: @station.property_id, railway: @station.railway, station: @station.station } }
    end
  ...
  test "should update station" do
    patch station_url(@station), params: { station: { distance: @station.distance, property_id: @station.property_id, railway: @station.railway, station: @station.station } }
